...
<html>
	<head>
		...
		<meta name="keywords" content="Entrainement, Développement, Web">
		<title></title>
	...
	<body>
		...
		<div class="contenu">
			<div class="image">
				<img src="http://lorempixel.com/output/technics-h-g-100-150-9.jpg" alt="Photo">
			</div>
			<div class="cont">
				...
				<div class="contentnav">
					<ul>
						<li><a href="#1" class="ancre">Début</a></li>
						<li><a href="#2" class="ancre">Paragraphe2</a></li>
						<li><a href="#3" class="ancre">P3</a></li>
						<li><a href="#4" class="ancre">P4</a></li>
						<li><a href="#5" class="ancre">P5</a></li>
						<li><a href="#6" class="ancre">P6</a></li>
						<li><a href="#7" class="ancre">P7</a></li>
						<li><a href="#8" class="ancre">P8</a></li>
					</ul>
				</div>
				<p>
					<h2 id="presentation">Développeur Web</h2>
				</p>
				<div class="overflow">
					<br id="1">
					<h3>Hac vel metuitur ...</h3>
					<p>
					sospitale ad validum domum dominantur colligati professio sedandos excogitatum vel professio amicum ut apud additumque acerbitates adminiculum ante amicum modum percontatum <strong>satis modum videat</strong>  acerbitates percontatum remedium est metuitur est validum modum excogitatum nequi eos visa vel modum remedium corpus percontatum dominantur dominantur eos capite alienis amicum labes aliud mundi <strong>purgaverint eos morborum</strong>  percontatum mundi purgaverint celsius ut amicum paucis ad remedium cautionibus metuitur modum quoniam domum metuitur etiam ad amicum sospitale <strong>excogitatum satis</strong>  in ut hac colligati non metuitur additumque quos paucis ita ut morborum quoniam excogitatum cautionibus paucis oculis celsius perferentem torpescit alienis hac visa.
					<p>
					<br></p>
					...
					<br><br id="3">
					<h3>Accenderat super his ...</h3></p>
					 incitatum propositum ad nocendum aliqua mulier vilis, quae ad palatium ut poposcerat intromissa insidias ei latenter obtendi prodiderat a militibus obscurissimis. quam Constantina exultans ut in tuto iam locata mariti salute muneratam vehiculoque inpositam per regiae ianuas emisit in publicum, ut his inlecebris alios quoque ad indicanda proliceret paria vel maiora.
					<p>
					<br></p>
					...
					<br>
					<br id="4">
					<h3>Nec vox accusatoris ...</h3></p>
					 ulla licet subditicii in his malorum quaerebatur acervis ut saltem specie tenus crimina praescriptis legum committerentur, quod aliquotiens fecere principes saevi: sed quicquid Caesaris implacabilitati sedisset, id velut fas iusque perpensum confestim urgebatur impleri.<p>
					<br></p>
					...
					<br></p>
					Et quoniam apud eos ut in capite mundi morborum acerbitates celsius dominantur, ad quos vel sedandos omnis professio medendi torpescit, excogitatum est adminiculum sospitale nequi amicum perferentem similia videat, additumque est cautionibus paucis remedium aliud satis validum, ut famulos percontatum missos quem ad modum valeant noti hac aegritudine colligati, non ante recipiant domum quam lavacro purgaverint corpus. ita etiam alienis oculis visa metuitur labes.<p>
					<br></p>
					...
					<br><br id="7">
					<h3>Primi igitur omnium ...</h3></p>
					statuuntur Epigonus et Eusebius ob nominum gentilitatem oppressi. praediximus enim Montium sub ipso vivendi termino his vocabulis appellatos fabricarum culpasse tribunos ut adminicula futurae molitioni pollicitos.<p>
					<br>
					<br>
					<br></p>
